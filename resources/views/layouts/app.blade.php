...
<meta
  name="description"
  content="المركز الوطني التعليمي لتشخيص وعلاج العقم البيضاء - الجبل الأخضر - منصة متكاملة لإدارة الخدمات الطبية والاستشارات المتخصصة في علاج العقم"
/>
<meta
  name="keywords"
  content="المركز الوطني التعليمي، تشخيص العقم، علاج العقم، البيضاء، الجبل الأخضر، خدمات طبية، استشارات طبية متخصصة"
/>
<meta name="author" content="المركز الوطني التعليمي لتشخيص وعلاج العقم البيضاء - الجبل الأخضر" />
...
<style>
  ...
  /* تحديث اللون الأساسي */
  :root {
    --primary-color: #2c94b8 !important;
    --bs-primary: #2c94b8 !important;
  }

  .btn-primary {
    background-color: #2c94b8 !important;
    border-color: #2c94b8 !important;
  }

  .btn-primary:hover {
    background-color: #2382a0 !important;
    border-color: #2382a0 !important;
  }
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="{{ route('sections') }}" class="b-brand text-primary">
                <img src="{{ asset('assets/images/logos/v-logo-white.png') }}" alt="{{ __('messages.app_name') }}" width="200" />
      </a>
    </div>
    <div class="navbar-content">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <img alt="صورة المستخدم" class="user-avtar wid-45 rounded-circle" src="{{ asset('https://ui-avatars.com/api/?name=' . implode('+', explode(' ', Auth::user()->name)) . '&background=2c94b8&color=fff') }}">
            </div>
      ...
      <ul class="pc-navbar">
        ...
        {{-- Dynamic Menu Based on Area --}}
        @php
          $area = get_area_name();
          $menuPath = 'layouts.menus.' . $area;
        @endphp

        @if($area && View::exists($menuPath))
          @include($menuPath)
        @endif
