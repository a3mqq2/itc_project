...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('messages.add_medical_file') }}</li>
@endsection
    ...
    <div class="col-md-12">
        <div class="card wizard-card">
            <div class="card-body">
                ...
                <form action="{{ route('reception.medical-files.store') }}" method="POST" id="medicalFileForm">
                    @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="file_number" id="file_number"
                                    ...
                                    value="{{ old('file_number', $nextFileNumber) }}" required>
                                @error('file_number')
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="husband_name" id="husband_name"
                                    ...
                                    value="{{ old('husband_name') }}" required>
                                @error('husband_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="husband_national_id" id="husband_national_id"
                                    ...
                                    value="{{ old('husband_national_id') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="husband_registry_number" id="husband_registry_number"
                                    ...
                                    value="{{ old('husband_registry_number') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="husband_dob" id="husband_dob"
                                    ...
                                    value="{{ old('husband_dob') }}" required>
                                @error('husband_dob')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="wife_national_id" id="wife_national_id"
                                    ...
                                    value="{{ old('wife_national_id') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="wife_registry_number" id="wife_registry_number"
                                    ...
                                    value="{{ old('wife_registry_number') }}" required>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        ...
                        <div>
                            ...
                            <button type="submit" class="btn btn-success d-none" id="submitBtn">
                                <i class="ti ti-check me-1"></i>{{ __('messages.finish') }}
                            </button>
                        </div>
                    </div>
                </form>
